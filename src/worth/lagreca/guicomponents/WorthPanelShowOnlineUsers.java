...
public class WorthPanelShowOnlineUsers extends WorthPanel{

	public WorthPanelShowOnlineUsers(WorthFrame frame) {
		...
		while(iterator.hasNext()) {
			...
			if(u.getUtenteRegistratoState() == true) {
		...
		btnRefresh.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				//pulsante per aggiornare gli utenti online
